...
script_path = './TrainingScript.py'

# indicate interpreter path
interpreter_path = '/home/farokhmanesh/anaconda3/envs/wbd/bin/python' # adapt that for your purposes
...
if __name__ == '__main__':
    ...
    #job_maker_multi.export_jobs(queue)
